...
- ## Instructions:-
  ...
  - ### Gameplay:-
   ...
   - ### Game Features:-
      ...
      - **Score:- Keep track of your score based on the number of apples eaten.**
...
- ## How to install the game :-
  ...
  - ### Way 1:- Direct play
    ...
    - ### Step 2:- If you see any error message like this. then click on more info and then click "Run anyway" button
